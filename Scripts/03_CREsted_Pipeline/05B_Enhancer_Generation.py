...
Optimizer_function = crested.tl.design.EnhancerOptimizer(optimize_func = intra_line_variance_MWD)
...
os.makedirs("output/CREsted_ISE/LineAdj_VarAdj_MWD", exist_ok=True)
...
plt.savefig("output/CREsted_ISE/LineAdj_VarAdj_MWD/Comb_MH_Designed_enhancers.png", dpi=300)
plt.close()
...
plt.savefig("output/CREsted_ISE/LineAdj_VarAdj_MWD/MH_Stepwise_Class_Predictions.png")
plt.close()
...
for i in range(len(met_lo_designed_sequences)):
    ...
    crested.pl.region.bar(prediction, classes=list(adata_specific.obs_names), title=f"Designed enhancer {i+1}", ax=axs[i], show=False)
plt.savefig("output/CREsted_ISE/LineAdj_VarAdj_MWD/Comb_ML_Designed_enhancers.png", dpi=300)
plt.close()
...
plt.savefig("output/CREsted_ISE/LineAdj_VarAdj_MWD/ML_Stepwise_Class_Predictions.png")
plt.close()
...
all_sequences_df.to_csv("output/CREsted_ISE/LineAdj_VarAdj_MWD/final_enhancer_sequences.csv", index=False)
